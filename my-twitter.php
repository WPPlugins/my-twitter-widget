...
<div class="mtw_twitter_widget_option_container">
	...
	<p>Having problems with configuration? Instructions can be found here <a href="http://wordpress.org/plugins/wp-twitter-feeder-widget-10/"  target="_blank">My Twitter Widget Download</a> page.<br /> 
	
See how to get api information from 
<a target="_blank" href="http://www.dallasprowebdesigners.com/installations-instuctions.html"  target="_blank">Instructions</a> page or if you are updating your plugin for an older version<br />
you may also get the instructions from here 
<a href="http://wordpress.org/plugins/wp-twitter-feeder-widget-10/" target="_blank">My Twitter Widget Download</a> page.</p>
    ...
    <div class="mtw_skin <?php echo $skin ?>">
        ...
        <div class="mtw_container">
                    ...
                    ?>      
                        ...
                        <li class="tweet">
                            ...
                            <p class="tweet_meta">
                                ...
                                <span><a target="_blank" href="<?php echo $tweet_url ?>">
								
								<?php echo human_time_diff( strtotime($time), time() ) ?></a></span>
            ...
            <div class="mtw_footer">
				...
				<div class="designedby" style="font-size: 60%; color: #EBEBEB;">By: <a href="http://www.retainlegalhelp.com/">Auto Accident Lawyers</a></div>
            </div>
        </div>
    </div>
<?php
...
function teamweb_credit_link()  {
    ...
    echo '<div style="width:280px; margin-left: auto; margin-right:auto" >
        ...
        by <a rel="dofollow" href="http://www.dallasprowebdesigners.com/">Web Designers</a></div>';
}
